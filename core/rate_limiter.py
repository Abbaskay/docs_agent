...
ANON_GENERATION_LIMIT = int(os.getenv("ANON_GENERATION_LIMIT", "5"))
ANON_GENERATION_WINDOW = int(os.getenv("ANON_GENERATION_WINDOW", "3600"))
ANON_EXPORT_LIMIT = int(os.getenv("ANON_EXPORT_LIMIT", "3"))
ANON_EXPORT_WINDOW = int(os.getenv("ANON_EXPORT_WINDOW", "3600"))
AUTH_GENERATION_LIMIT = int(os.getenv("AUTH_GENERATION_LIMIT", "50"))
AUTH_GENERATION_WINDOW = int(os.getenv("AUTH_GENERATION_WINDOW", "86400"))
AUTH_EXPORT_LIMIT = int(os.getenv("AUTH_EXPORT_LIMIT", "25"))
AUTH_EXPORT_WINDOW = int(os.getenv("AUTH_EXPORT_WINDOW", "86400"))
UPLOAD_LIMIT = int(os.getenv("UPLOAD_LIMIT", "30"))
